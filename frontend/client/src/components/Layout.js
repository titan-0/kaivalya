...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Stock Suggestions', href: '/stock-suggestions', icon: Package },
    { name: 'Historical Data', href: '/historical-data', icon: History },
    { name: 'Stock Details', href: '/stock-details', icon: Search },
    { name: 'Model Factors', href: '/model-factors', icon: Settings },
    { name: 'Model Insights', href: '/model-insights', icon: Brain },
    { name: 'Order Management', href: '/order-management', icon: ShoppingCart },
    { name: 'Admin Settings', href: '/admin-settings', icon: Users },
  ];
